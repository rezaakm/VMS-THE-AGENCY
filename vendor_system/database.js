...
// Load and import project data (optional)
try {
  const projectPath = path.join(__dirname, '..', 'cost_data_v2.json');
  if (!fs.existsSync(projectPath)) throw new Error('File not found');
